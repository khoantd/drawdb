...
const en = {
  translation: {
    ...
    ai_chat_placeholder: "Ask AI for help with your schema...",
    ai_endpoint: "LiteLLM Endpoint URL",
    ai_api_key: "API Key",
    ai_test_connection: "Test Connection",
    ai_connection_success: "Connected successfully",
    ai_connection_failed: "Connection failed",
    ai_apply_suggestion: "Apply Suggestion",
    ai_generating: "AI is thinking...",
    ai_welcome_message: "Hi! I'm your AI database assistant. I can help you optimize schemas, generate SQL, and create tables from descriptions.",
    ai_help_examples: "Try asking: 'Create a blog system' or 'Optimize my schema'",
    ai_retry: "Retry",
    ai_copied: "Copied!",
    ai_copy_code: "Copy Code",
    ai_copy_response: "Copy Response",
    ai_settings_saved: "AI settings saved successfully",
    ai_fill_required_fields: "Please fill in all required fields",
    ai_assistant_settings: "AI Assistant Settings",
    ai_enable_assistant: "Enable AI Assistant",
    ai_enable_description: "Get intelligent help with database design, schema optimization, and SQL generation.",
    ai_save_settings: "Save Settings",
    ai_reset: "Reset",
    ai_help_title: "How to use AI Assistant",
    ai_help_description: "The AI Assistant can help you design better databases by analyzing your schema and providing intelligent suggestions.",
    ai_supported_features: "Supported Features",
    ai_feature_schema_optimization: "Schema optimization and suggestions",
    ai_feature_sql_generation: "SQL query generation and validation",
    ai_feature_natural_language: "Natural language to schema conversion",
    ai_feature_relationship_analysis: "Relationship analysis and recommendations",
    ai_feature_index_suggestions: "Index and constraint suggestions",
    ai_applied_table_suggestion: "Applied table suggestion: {{tableName}}",
    ai_applied_relationship_suggestion: "Applied relationship: {{fromTable}} → {{toTable}}",
    ai_applied_optimizations: "Applied {{count}} optimizations",
